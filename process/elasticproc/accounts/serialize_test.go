...
func TestSerializeAccounts(t *testing.T) {
	...
	expectedRes := `{ "update" : {"_index": "accounts", "_id" : "addr1", "retry_on_conflict":3 } }
...
func TestSerializeAccountsESDTNonceZero(t *testing.T) {
	...
	expectedRes := `{ "update" : {"_index": "accountsesdt", "_id" : "addr1-token-abcd-00", "retry_on_conflict":3 } }
...
func TestSerializeAccountsESDT(t *testing.T) {
	...
	expectedRes := `{ "update" : {"_index": "accountsesdt", "_id" : "addr1-token-0001-05", "retry_on_conflict":3 } }
...
func TestSerializeAccountsNFTWithMedaData(t *testing.T) {
	...
	expectedRes := `{ "update" : {"_index": "accountsesdt", "_id" : "addr1-token-0001-16", "retry_on_conflict":3 } }
...
func TestSerializeAccountsESDTDelete(t *testing.T) {
	...
	expectedRes := `{ "update" : {"_index":"accountsesdt", "_id" : "addr1-token-0001-00", "retry_on_conflict":3 } }

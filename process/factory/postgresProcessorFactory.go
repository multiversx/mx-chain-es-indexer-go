...
// ArgPostgresProcessorFactory is struct that is used to store all components that are needed to create an elastic processor factory
type ArgPostgresProcessorFactory struct {
	Marshalizer              marshal.Marshalizer
	Hasher                   hashing.Hasher
	AddressPubkeyConverter   core.PubkeyConverter
	ValidatorPubkeyConverter core.PubkeyConverter
	DBClient                 processIndexer.PostgresClientHandler
...
func CreatePostgresProcessor(arguments ArgPostgresProcessorFactory) (indexer.ElasticProcessor, error) {
